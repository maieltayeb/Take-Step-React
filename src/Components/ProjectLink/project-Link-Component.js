...
return (
  <>
 {
               Object.values(tasks).map((task,i) => {
                const user =  props.volunteerUsersById.find(u => u.id === task.volunteerId);
               
           
                        return (
                          <div className="project-link-container">
      <div className="project-link-text">
  <span className="project-link-span"> <a href={[task.taskLink]} target="_blank"> project Link</a></span>
