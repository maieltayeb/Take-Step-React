...
<div className="postContainer">
    ...
    <p className="ml-0 mt-5  postOwnerNameStyle float-left">Front End Developer</p>
    ...
    <div className="postBody">
      <p className="p-5 m-0  text-justify"> is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text 
        ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. ….more</p>
    </div>
...
<div className="clearfix">
  ...
  <Input placeholder="Add your comment" className="mt-3 commentArea" ></Input>
  </div>
</div>
<div className="clearfix">
  <div className=" float-left ">
