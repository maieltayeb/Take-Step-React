...
_onBlur=(e)=>{
    ...
    e.currentTarget.placeholder = "Expire-Date";
}
  render() { 
    return ( <Container>
      <Form
      ...
      >
        ...
        <FormGroup className="input-icons">
          <i class="far fa-credit-card icon text-warning"></i>
          <Input
            type="Number"
            name="email"
            id="exampleEmail"
        ...
        <FormGroup className="input-icons">
        <i class="far fa-calendar-alt icon text-warning"></i>
          {/* <i class="fa fa-envelope icon text-warning"></i> */}
          <Input
            type="text"
            name="email"
        ...
        <FormGroup className="input-icons">
          <i class="fas fa-phone-alt icon text-warning"></i>
        ...
        <FormGroup className="input-icons">
        <i class="fas fa-euro-sign icon text-warning"></i>
          {/* <i class="fa fa-envelope icon text-warning"></i> */}
          <Input
            type="Number"
            name="email"
